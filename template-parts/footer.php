            ...
            <div class="columns">
                <div class="column -width-1/4 -width-1/2@md -width-1/1@sm -width-1/1@xs">
                    <div class="footer__col -pad-horizontal">
                        <h3 class="nav__heading -mar-bottom-xxl">
                            <a class="footer__logo -mar-top-xs" href="https://www.calgary-real-estate.com/">
                ...
                <div class="column -width-1/4 -width-1/2@md -width-1/1@sm -width-1/1@xs">
                    <div class="nav nav--stacked">
                        ...
                        <ul class="nav__list">
                            <li class="nav__item">
                                <a class="nav__link -text-invert -pad-sm" href="https://www.calgary-real-estate.com/agents.php">About Us</a>
                            </li>
                            <li class="nav__item">
                                <a class="nav__link -text-invert -pad-sm" href="https://www.calgary-real-estate.com/agents.php">Our Agents</a>
                            </li>
                            <li class="nav__item">
                                <a class="nav__link -text-invert -pad-sm" href="https://www.calgary-real-estate.com/listings.php">Our Listings</a>
                            </li>
                            <li class="nav__item">
                                <a class="nav__link -text-invert -pad-sm" href="https://www.calgary-real-estate.com/contact.php">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="column -width-1/4 -width-1/2@md -width-1/1@sm -width-1/1@xs">
                    <div class="nav nav--stacked">
                        ...
                        <ul class="nav__list">
                            ...
                            <li class="nav__item">
                                <a class="nav__link -text-invert -pad-sm" href="https://www.calgary-real-estate.com/communities.php">Subdivision
                                    List</a>
                            </li>
                            <li class="nav__item">
                                <a class="nav__link -text-invert -pad-sm" href="https://www.calgary-real-estate.com/home-evaluation.php">Home
                                    Evaluation</a>
                            </li>
...
-->
            ...
            <div class="footer__bottom -pad-vertical -clear -text-xs">
                <div class="-left@lg -left@xl -mar-vertical-sm -pad-horizontal-sm">
                    <p>The trademarks REALTOR&reg;, REALTORS&reg; and the REALTOR&reg; logo are controlled by
                        The Canadian Real Estate Association (CREA) and identify real estate professionals who
                        are members of CREA. Used under license. The trademarks MLS&reg;, Multiple Listing
                        Service&reg; and the associated logos are owned by The Canadian Real Estate Association
                        (CREA) and identify the quality of services provided by real estate professionals who
                        are members of CREA. Used under license.</p>
                    &copy; Copyright 2022,
                    <a href="http://www.realestatewebmasters.com/" rel="nofollow" target="_blank">Real Estate
                        Webmasters</a> All Rights Reserved.
                </div>
                <div class="-right@lg -right@xl -mar-bottom footer--links">
                    <a class="-right" href="http://www.realestatewebmasters.com/" target="_blank">
                        <svg role="img" class="logo logo--rew">
                            ...
                            <use xlink:href="https://www.calgary-real-estate.com/inc/skins/ce/img/assets.svg#logo--rew" />
                        </svg>
                    </a>
                    <div class="nav -inline">
                        <a href="https://www.calgary-real-estate.com/idx/sitemap.html?p=60">Listings Site
                            Map</a> Copyright 2009-2019 Christopher
                        Audette; RE/MAX First; #115 8820 Blackfoot Trail SE • Calgary, AB • T2J 3J1
                        (403) 255-9555. All Rights Reserved. <a href="https://www.calgary-real-estate.com/privacy-policy.php">Privacy Policy</a> <a href="https://www.calgary-real-estate.com/sitemap.php">Sitemap</a>

                        <div class=pagination><a href="https://www.calgary-real-estate.com/backend" rel="nofollow">Agent Login</a> | <a href="http://www.real-estate.ca/blog/dashboard.html" rel="nofollow">Agent
                                Dashboard</a> </div>
                    </div>
                </div>
            </div>
...
BREW.Window.UI = {
    ...
    closeButtonHtml: '<a class="close">' + '<svg class="icon icon--xs">' + '<use xlink:href="https://www.calgary-real-estate.com/inc/skins/ce/img/assets.svg#icon--close" />' + '</svg>' + '</a>'
};
</script>
